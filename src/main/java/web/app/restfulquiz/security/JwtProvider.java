...
public class JwtProvider {
    ...
    public Optional<AuthUserDetail> resolveToken(HttpServletRequest request){
        ...
        if(prefixedToken == null)
            token = "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJhbGFueiIsInBlcm1pc3Npb25zIjpbeyJhdXRob3JpdHkiOiJyZWFkIn0seyJhdXRob3JpdHkiOiJ3cml0ZSJ9XX0.KaorqZx5WTxYIJ3IlYv249YVqTrbcES_Ypy73MF__7I";
        else
